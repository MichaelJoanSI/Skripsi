                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('admin.advanced')}}" class="nav-link">
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h4>
                                    ...
                                    <small class="float-right">Date: 2/02/2024</small>
                                </h4>
                            </div>
                            <!-- /.col -->
                        </div>
                        ...
                        <div class="row invoice-info">
                            <div class="col-sm-4 invoice-col">
                                From
                                <address>
                                    <strong>Toko Berkat</strong><br>Jalan Raya Selatan Wangon no.24<br>Wangon, 55175<br>
                            ...
                            <div class="col-sm-4 invoice-col">
                                To
                                <address>
                                    <strong>Michael Joan R</strong><br>Jalan Ahmad Yamin no.110 Wangon<br>Wangon, 55175<br>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Mie Sedap</td>
                                            <td>455-981-221</td>
                                            <td>Mie Sedap Rasa Ayam Bawang</td>
                                            <td>Rp.110.000</td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <p class="text-muted well well-sm shadow-none" style="margin-top: 10px;">
                                    Jenis pembayaran yang bisa dilakukan untuk pembayaran
                                </p>
                            </div>
                            <!-- /.col -->
                            <div class="col-6">
                                <p class="lead">Tanggal Pembayaran 19/01/2024</p>
