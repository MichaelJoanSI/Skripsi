...
<div class="content-wrapper">
    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('pembelian.store') }}" method="post">
            ...
            <!-- Kode Pembelian -->
            <div class="row mb-3">
                <label for="nama_transaction" class="col-sm-2 col-form-label">Kode Pembelian:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kode_pembelian" name="kode_pembelian" placeholder="Masukkan Kode Pembelian" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="tgl_masuk" name="tgl_masuk" placeholder="yyyy-mm-dd" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="tgl_keluar" name="tgl_keluar" placeholder="yyyy-mm-dd" required>
                </div>
            </div>

            <!-- Satuan -->
            <div class="row mb-3">
                <label for="harga_jual" class="col-sm-2 col-form-label">Satuan</label>
                <div class="col-sm-10">
            ...
            <!-- Harga Beli -->
            <div class="row mb-3">
                <label for="quantity" class="col-sm-2 col-form-label">Harga Beli</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="harga_beli" name="harga_beli" placeholder="Masukan Harga" required>
                </div>
            </div>
            ...
            <div class="col-sm-10 offset-sm-2">
                ...
                <button type="button" class="btn btn-info" onclick="window.location='{{route('detailpembelian.index')}}'">View</button>
                </div>
            </div>
        </form>
    </div>
