  ...
  <nav class="main-header navbar navbar-expand navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link active" style="color: blue;">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
                ...
                <div class="row">
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      <span class="description-percentage text-success"><i class="fas fa-caret-up"></i> 10%</span>
                  ...
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      <span class="description-percentage text-warning"><i class="fas fa-caret-left"></i> 2%</span>
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20">30 kg</div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div class="sparkbar" data-color="#f39c12" data-height="20">100 kg</div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div class="sparkbar" data-color="#f56954" data-height="20">20 Dus</div>
                      </td>
                    </tr>
                    <tr>
                      <td><a href="pages/examples/invoice.html">OR7429</a></td>
                      ...
                      <td>
                        <div class="sparkbar" data-color="#00c0ef" data-height="20">50 Liter</div>
                      </td>
                    </tr>
                    <tr>
                      <td><a href="pages/examples/invoice.html">OR1848</a></td>
                      ...
                      <td><span class="badge badge-warning">Pending</span></td>
                      <td>
                        <div class="sparkbar" data-color="#f39c12" data-height="20">100 Dus</div>
                      </td>
                    </tr>
                    <tr>
                      <td><a href="pages/examples/invoice.html">OR7429</a></td>
                      <td>Perabotan Rumah</td>
                      <td><span class="badge badge-danger">Delivered</span></td>
                      <td>
                        <div class="sparkbar" data-color="#f56954" data-height="20">30 Pcs</div>
                      </td>
                    </tr>
                    <tr>
                      <td><a href="pages/examples/invoice.html">OR9842</a></td>
                      ...
                      <td><span class="badge badge-success">Success</span></td>
                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20">50 Kg</div>
                      </td>
                    </tr>
                    </tbody>
                  </table>
